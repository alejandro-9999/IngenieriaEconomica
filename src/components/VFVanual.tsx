...
function VFVanual() {
    ...
    const formula = `A = \\frac{VP}{\\left[  \\frac{(1 + i)^n - 1}{i} \\right]}`;
    ...
    useEffect(() => {
        ...
        const new_formule = `${fomuleValidator(result,'A')} = \\frac{${fomuleValidator(principal,'VP')}}{\\left[  \\frac{(1 + ${fomuleValidator(interestRate/100,'i')})^{${fomuleValidator(compoundingPeriods,'n')}} - 1}{${fomuleValidator(interestRate/100,'i')}} \\right]}`;
