...
function VPAanual() {
    ...
    const formula = `A = \\frac{VP}{\\left[  \\frac{1 - (1 + i)^{-n}}{i} \\right]\\left( 1 + i \\right)}`;
    ...
    const calculate = () => {
        ...
        const A = principal/((( (1 - Math.pow(1 + decimalInterestRate, -compoundingPeriods))) / decimalInterestRate)*(1 + decimalInterestRate));
    ...
    useEffect(() => {
        ...
        const new_formule = `${fomuleValidator(result,'A')} = \\frac{${fomuleValidator(principal,'VP')}}{\\left[  \\frac{1-(1 + ${fomuleValidator(interestRate/100,'i')})^{-${fomuleValidator(compoundingPeriods,'n')}}}{${fomuleValidator(interestRate/100,'i')}} \\right]\\left( 1 + ${fomuleValidator(interestRate/100,'i')} \\right)}`;
